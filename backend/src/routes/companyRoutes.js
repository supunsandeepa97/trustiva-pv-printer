...
router.post('/logo',             verifyToken, requireRole(managers), imageUpload.single('logo'), company.uploadLogo);
router.post('/watermark',        verifyToken, requireRole(managers), imageUpload.single('watermark'), company.uploadWatermark);
router.post('/signature/:slot',  verifyToken, requireRole(managers), imageUpload.single('signature'), company.uploadSignature);
