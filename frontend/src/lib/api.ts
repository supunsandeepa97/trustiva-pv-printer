...
export const PlatformAPI = {
  ...
  requestDeleteOtp:   (id: string)                    => api.post(`/platform/companies/${id}/otp`),
  deleteCompany:      (id: string, otp: string)       => api.delete(`/platform/companies/${id}`, { data: { otp } }),
  listBin:            ()                              => api.get('/platform/bin'),
  restoreCompany:     (id: string)                    => api.post(`/platform/bin/${id}/restore`),
